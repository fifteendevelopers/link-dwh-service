...
CREATE TABLE `Dim_Delivery_Header` (
  ...
  `Alt_Delivery_Location` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `Notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `Instructor_General_Notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
