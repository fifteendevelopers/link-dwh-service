...
CREATE TABLE `Fact_Grant_Reallocations` (
  ...
  `Reallocation_Type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Status_Raw` tinyint NOT NULL DEFAULT '0',
  `Reallocation_Notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `Reallocation_Increase_Reasons` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
